...
namespace Chaos_Stage
{
    public partial class gameForm: Form
    {
        ...
        {
            // Center all panels
            CenterPanel(mainMenuPanel);
            CenterPanel(gameInstructionPenal);
            CenterPanel(chooseLevelPanel);
            CenterPanel(gamePlayLevel1Panel);
            CenterPanel(gamePlayLevel2Panel);
            CenterPanel(gamePlayLevel3Panel);
            CenterPanel(gamePlayLevel4Panel);
            CenterPanel(gamePlayLevel5Panel);
            CenterPanel(gamePlayLevel6Panel);
            CenterPanel(gamePlayLevel7Panel);
            CenterPanel(gamePlayLevel8Panel);
            CenterPanel(gamePlayLevel9Panel);
            CenterPanel(gamePlayLevel10Panel);
            CenterPanel(pausePanel);
            CenterPanel(nextLevelPanel);
            CenterPanel(gameOverPanel);
            CenterPanel(blockPanel);
